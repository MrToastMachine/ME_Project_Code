...
# Try opening requirements file and reading all packages
try:
    file = open("requirements.txt", "r")
    file_lines = file.readlines()
    required = [line.strip() for line in file_lines]
    file.close()
except FileNotFoundError:
    print("[ERROR] Could not find requirements.txt file in directory")
