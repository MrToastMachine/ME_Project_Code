...
void parseInterruptsToObjects(vector<int> interrupt_times){
...
int main(int argc, char const *argv[]) {
    ...
    parseInterruptsToObjects(interrupt_times_all);
    ...
    for (int i = 0; i < sensor_A_start_dists.size(); i++){
        cout << sensor_A_start_dists[i] << ", " << sensor_A_lengths[i] << endl;
    }
